...
<html>
  ...
  <div id="popup1" class="overlay">
		<div class="popup">
			<?php
		    	$result = mysqli_query($mysql_connection,"SELECT * FROM  rooms_in_cities"); ?>
			...
			<div class="content">
				<nav class="dropdown" style = "right:190px; display:block; width:700px; right:-100px;">
					<button onclick="myFunction()" class="dropbtn" style = "padding-left:120px; padding-right: 120px;">Press Me!</button>
				  	<div id="myDropdown" class="dropdown-content show" style = " display:block; width:310px;">
					    <input type="text" placeholder="Search..." id="myInput" style = "margin: 0%; padding: 1% 3%; width:342px;" onkeyup="filterFunction()">
					    	<div id = "scroll" style = "width:400px;">
					    	<?php
					    		
					    		echo('<table class = "scroll_list" style = "position:relative; right:-40px;"><tr><th>Room_ID</th><th>City</th><th>Hotel_ID</th></tr>');
						    	while($row = mysqli_fetch_array($result))
								{
									echo ('<tr><td style="background-color : #808080;">'. $row['Room_ID'] .'</td><td >' . $row['City'] . '</td></a><td>' . $row['Hotel_ID'] .'</td></tr>');
								}
								echo('</table>');
							?>
