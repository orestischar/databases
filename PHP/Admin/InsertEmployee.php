...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO `Employee` VALUES ('$Employee_IRS_Number','$Social_Security_Number','$First_Name','$Last_Name','$Street','$Number','$Postal_Code','$City')";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2>Please fill the following form to insert a record in the table of Employees and press Submit!</h2><br>
				...
				<div class="content">
					 <form action="InsertEmployee.php" method="post">
						...
						<input  type="int"  name="Employee_IRS_Number" placeholder="Employee's IRS Number..." value="<?php echo $Employee_IRS_Number;?>" required><br>
						...
						<input  type="text" name="First_Name" placeholder="Employee's First Name..." value="<?php echo $First_Name;?>" required><br>

						<label for="Last_Name">Last Name:</label><br>
						<input  type="text"  name="Last_Name" placeholder="Employee's Last Name..." value="<?php echo $Last_Name;?>" required><br>

						<label for="Street">Street Name:</label><br>
						<input  type="text" name="Street" placeholder="Employee's Street Address..." value="<?php echo $Street;?>" required><br>

						<label for="Number">Street Number:</label><br>
						<input type="text" name="Number" placeholder="Employee's Street Number..." value="<?php echo $Number;?>" required><br>
