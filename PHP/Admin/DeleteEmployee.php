...
<?php
	...
	if(isset($_GET['Employee_IRS_Number'])  && isset($_GET['Social_Security_Number']))
	{		
		...
		else
		{
			...
			header("Location: DeleteEmployee.php#popup2");
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "DELETE FROM `Employee` WHERE Employee_IRS_Number ='$Employee_IRS_Number' AND Social_Security_Number = '$Social_Security_Number' ";
...
<html>
	...
	<div id = "popup2" class="overlay">
		<div class="popup">
			<?php echo $error; ?>
			<h2>Employee will be deleted permantly. Proceed? </h2><br>
			<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
			<div class="content">
				<form action = "DeleteEmployee.php#popup4">
	...
	<div id="popup3" class="overlay">
		<div class="popup">
		    ...
		    ?>
			<h2>Choose an Employee to kill and press submit to update the chosen row!</h2><br><br><br>
				  	...
				  	<div id="myDropdown" class="dropdown-content">
					    <input type="text" placeholder="Search..." id="myInput" onkeyup="filterFunction()">
					    	...
					    	<?php
								...
								{
									echo ('<tr><td style="background-color : #808080;"><a href="DeleteEmployee.php?Employee_IRS_Number=' . $row['Employee_IRS_Number'] . '&Social_Security_Number=' . $row['Social_Security_Number'].'">' . $row['Employee_IRS_Number'] .'</td><td style="background-color : #808080;">'. $row['Social_Security_Number'] .'</td><td >' . $row['First_Name'] . '</td></a><td>' . $row['Last_Name'] . '</td><td >' . $row['Street'] .'</td><td>'. $row['Number'] . '</td><td >'  . $row['Postal_Code'] . '</td><td>'  . $row['City']. '</td></tr>');
	...
	<div id="popup4" class="overlay">
		<div class="popup">
			<div class = "content">
				<h2>Press submit to delete the chosen row!</h2><br><br><br>
				<a class="close" href="index.php"><button type="button" id="delete"><h2>X</h2></button></a>
