...
<?php
	...
	{		
		...
		header("Location: InsertRoomAmenities.php#popup1");
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO `Room_Amenities` VALUES ('$Room_ID','$Hotel_ID', '$Amenities')";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2>Please fill the following form to insert Hotel Room's amenities, seperated by comma (,)!</h2><br>
				<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
				<div class="content">
					 <form action="InsertRoomAmenities.php" method="post">
						...
						<input type="\s+((,\s)*)." name="Amenities" placeholder="Hotel Room's Amenities..." value="<?php echo $Amenities;?>" required><br>
