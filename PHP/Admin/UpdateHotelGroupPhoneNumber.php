...
<?php
	...
	{		
		...
		header("Location: UpdateHotelGroupPhoneNumber.php#popup1");
	...
	{	
		...
		$query = " UPDATE `Hotel_Group_Phone_Number` SET Phone_Number = '$Phone_Number' WHERE Hotel_Group_ID = '$Hotel_Group_ID'";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2>Please fill the following form to update the phone number for the specific Hotel Group and press Submit!</h2><br>
				<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
				<div class="content">
					 <form action="UpdateHotelGroupPhoneNumber.php" method="post">
						...
						<input  type="tel" name="Phone_Number" placeholder="Hotel Group's Phone Number..." value="<?php echo $Phone_Number;?>" required><br>
