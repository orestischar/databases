...
<?php
	...
	if(isset($_GET['Hotel_Group_ID']) && isset($_GET['Number_Of_Hotels']))
	{		
		...
		{	
			...
			header("Location: DeleteHotelGroup.php#popup2");
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "DELETE FROM `Hotel_Group` WHERE Number_Of_Hotels = '$Number_Of_Hotels' AND Hotel_Group_ID ='$Hotel_Group_ID' ";
...
<html>
	...
	<div id = "popup2" class="overlay">
		<div class="popup">
			<?php echo $error; ?>
			<h2>Hotel Group's Email Address and Phone Number will be automatically deleted. </h2><br>
			<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
			<div class="content">
				<form action = "DeleteHotelGroup.php#popup4">
	...
	<div id="popup3" class="overlay">
		<div class="popup">
		    ...
		    ?>
			<h2>Choose a Hotel Group to kill and press submit to update the chosen row!</h2><br><br><br>
			<a class="close" href="index.php"><button type="button" id="delete"><h2>X</h2></button></a>

			<div class="content">
				<nav class="dropdown">
					<button onclick="myFunction()" class="dropbtn">Choose a Hotel Group to Delete</button>
				  	<div id="myDropdown" class="dropdown-content show">
					    <input type="text" placeholder="Search..." id="myInput" onkeyup="filterFunction()">
					    	...
					    	<?php
								...
								{
									echo ('<tr><td style="background-color : #808080;"><a href="DeleteHotelGroup.php?Hotel_Group_ID=' . $row['Hotel_Group_ID'] . '&Number_Of_Hotels=' . $row['Number_Of_Hotels'].'">' . $row['Hotel_Group_ID'] .'</td><td style="background-color : #808080;">'. $row['Number_Of_Hotels'] .'</td><td>' . $row['Street'] .'</td><td>'. $row['Number'] . '</td><td>'  . $row['Postal_Code'] . '</td><td>'  . $row['City'] . '</td></tr>');
	...
	<div id="popup4" class="overlay">
		<div class="popup">
			<div class = "content">
				...
				<form  action = "DeleteHotelGroup.php" method="post">
