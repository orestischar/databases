...
<?php
	...
	{		
		...
		header("Location: InsertHotelPhoneNumber.php#popup1");
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO `Hotel_Phone_Number` VALUES ('$Hotel_ID', '$Phone_Number')";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2>Please fill the following form to insert a phone number for the specific Hotel and press Submit!</h2><br>
				<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
				<div class="content">
					 <form action="InsertHotelPhoneNumber.php" method="post">
						...
						<input  type="tel" name="Phone_Number" placeholder="Hotel's Phone_Number..." value="<?php echo $Phone_Number;?>" required><br>
