...
<?php
	...
	{	
		...
		{	
			...
			$Paid = $row["Paid"];
			header("Location: UpdateReserves.php#popup4");
	...
	{	
		...
		$query = "UPDATE `Reserves` SET Start_Date ='$Start_Date', Finish_Date ='$Finish_Date', Paid='$Paid' WHERE Customer_IRS_Number = '$Customer_IRS_Number' AND Hotel_ID ='$Hotel_ID' AND Room_ID ='$Room_ID' ";
...
<html>
	...
	<div id="popup3" class="overlay">
		<div class="popup">
			...
			?>
			<h2 style = "font-size: 20px;">Choose Customer,Hotel and Room,fill the following form and press submit to update rest reservation's info!</h2><br><br><br>
			...
			<div class="content">
					    ...
					    <input type="text" placeholder="Search..." id="myInput" onkeyup="filterFunction()">
					    	...
					    	<?php
								...
								{	
									...
									echo ('<tr><td style="background-color : #808080;"><a href="UpdateReserves.php?Customer_IRS_Number=' . $row['Customer_IRS_Number'].'&Hotel_ID=' . $row['Hotel_ID']. '&Room_ID=' . $row['Room_ID'] . '">' . $row['Customer_IRS_Number'] . '</td><td style="background-color : #808080;">' .$row['Hotel_ID'] . '</td><td style="background-color : #808080;">'. $row['Room_ID'] . '</td><td>'. $row['First_Name'] .'</td><td>'. $row['Last_Name'] .'</td><td>' . $row['Start_Date'] .'</td><td>'. $row['Finish_Date'] . '</td><tr>');
				...
				<input type="int" name="Room_ID" placeholder="Reservation's Room..." disabled><br>
	...
	<div id="popup4" class="overlay">
		<div class="popup">
			<div class = "content">
				...
				<form  action = "UpdateReserves.php" method="post">
						...
						<label for="Room_ID">Room ID:</label><br>
						<input type="int" name="Room_ID" placeholder="Reservation's Room...<?php echo $Room_ID;?>" required><br>

						<label for="Start_Date">Start Date:</label><br>
						<input type="date" name="Start_Date" placeholder="<?php echo $Start_Date;?>" required><br>

						<label for="Finish_Date">Finish Date:</label><br>
						<input type="date" name="Finish_Date" placeholder="<?php echo $Finish_Date;?>"><br>

						<label for="Paid">Paid:</label><br>
						<input type="checkbox" name="Paid" placeholder="<?php echo $Paid;?>" required><br>
