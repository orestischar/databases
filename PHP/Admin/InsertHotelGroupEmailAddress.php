...
<?php
	...
	{		
		...
		header("Location: InsertHotelGroupEmailAddress.php#popup1");
	...
	if(isset($_POST['submit']))
	{
		...
		$query = "INSERT INTO `Hotel_Group_Email_Address` VALUES ('$Hotel_Group_ID', '$Email_Address')";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2>Please fill the following form to insert an email address for the specific Hotel Group and press Submit!</h2><br>
				<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
				<div class="content">
					 <form action="InsertHotelGroupEmailAddress.php" method="post">
