...
<?php
	...
	{		
		...
		header("Location: UpdateHotelEmailAddress.php#popup1");
	...
	{	
		...
		$query = "UPDATE `Hotel_Email_Address` SET Email_Address = '$Email_Address' WHERE Hotel_ID = '$Hotel_ID'";
...
<html>
	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				<?php echo $error;?>
				<h2 style = "font-size:20px;">Please fill the following form to update the email address for the specific Hotel and press Submit!</h2><br>
				<a class="close" href="index.php"><button type="button" id="delete">X</button></a>
				<div class="content">
					 <form action="UpdateHotelEmailAddress.php" method="post">
						...
						<input  type="email" name="Email_Address" placeholder="Hotel's Email Address..." value="<?php echo $Email_Address;?>" required><br>
