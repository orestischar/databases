	...
	<?php require 'connectToDB.php'; ?>
		...
		<div id = "popup1" class="overlay">
			<div class="popup">
				...
				<nav class="dropdown">
					<button onclick="myFunction()" class="dropbtn">Choose an existing Customer for the Reservation</button>
					...
					<input  type="checkbox" name="Paid"  value="<?php echo $Stars;?>" disabled><br>
				...
				<div class = "content">
					...
					<a class="close" href="index.php"><button type="button" id="delete"><h2>X</h2></button></a>
						<form  action = "InsertReserves.php" method="post">
							...
							<label for="Paid">Paid:</label><br>
							<input type="checkbox" name="Paid"  value="<?php echo $Stars;?>"><br>
